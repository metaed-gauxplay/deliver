...
class DataFusionClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.datafusion.v1.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.datafusion.v1.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.datafusion.v1.OperationMetadata');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.datafusion.v1.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.cloud.datafusion.v1.OperationMetadata');
        const restartInstanceResponse = protoFilesRoot.lookup('.google.cloud.datafusion.v1.Instance');
        const restartInstanceMetadata = protoFilesRoot.lookup('.google.cloud.datafusion.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.datafusion.v1.DataFusion', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataFusionStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.datafusion.v1.DataFusion')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.datafusion.v1.DataFusion, this._opts, this._providedCustomServicePath);
