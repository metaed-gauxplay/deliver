...
class CloudFilestoreManagerClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            sharePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/instances/{instance}/shares/{share}'),
            snapshotPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/instances/{instance}/snapshots/{snapshot}'),
        };
        ...
        this.descriptors.page = {
            ...
            listShares: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'shares'),
        };
        ...
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const restoreInstanceResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Instance');
        const restoreInstanceMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const revertInstanceResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Instance');
        const revertInstanceMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const createSnapshotResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Snapshot');
        const createSnapshotMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const deleteSnapshotResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSnapshotMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const updateSnapshotResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Snapshot');
        const updateSnapshotMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const createBackupResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Backup');
        const createBackupMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const deleteBackupResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteBackupMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const updateBackupResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Backup');
        const updateBackupMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const createShareResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Share');
        const createShareMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const deleteShareResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteShareMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        const updateShareResponse = protoFilesRoot.lookup('.google.cloud.filestore.v1beta1.Share');
        const updateShareMetadata = protoFilesRoot.lookup('.google.cloud.common.OperationMetadata');
        this.descriptors.longrunning = {
            ...
            restoreInstance: new this._gaxModule.LongrunningDescriptor(this.operationsClient, restoreInstanceResponse.decode.bind(restoreInstanceResponse), restoreInstanceMetadata.decode.bind(restoreInstanceMetadata)),
            revertInstance: new this._gaxModule.LongrunningDescriptor(this.operationsClient, revertInstanceResponse.decode.bind(revertInstanceResponse), revertInstanceMetadata.decode.bind(revertInstanceMetadata)),
            ...
            createSnapshot: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createSnapshotResponse.decode.bind(createSnapshotResponse), createSnapshotMetadata.decode.bind(createSnapshotMetadata)),
            deleteSnapshot: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteSnapshotResponse.decode.bind(deleteSnapshotResponse), deleteSnapshotMetadata.decode.bind(deleteSnapshotMetadata)),
            updateSnapshot: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateSnapshotResponse.decode.bind(updateSnapshotResponse), updateSnapshotMetadata.decode.bind(updateSnapshotMetadata)),
            ...
            createShare: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createShareResponse.decode.bind(createShareResponse), createShareMetadata.decode.bind(createShareMetadata)),
            deleteShare: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteShareResponse.decode.bind(deleteShareResponse), deleteShareMetadata.decode.bind(deleteShareMetadata)),
            updateShare: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateShareResponse.decode.bind(updateShareResponse), updateShareMetadata.decode.bind(updateShareMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.filestore.v1beta1.CloudFilestoreManager', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.cloudFilestoreManagerStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.filestore.v1beta1.CloudFilestoreManager')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.filestore.v1beta1
                    .CloudFilestoreManager, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of cloudFilestoreManagerStubMethods) {
            const callPromise = this.cloudFilestoreManagerStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getShare(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    revertInstance(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkRevertInstanceProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     */
    async checkCreateSnapshotProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     */
    async checkDeleteSnapshotProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     */
    async checkUpdateSnapshotProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    createShare(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateShareProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteShare(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteShareProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    updateShare(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'share.name': (_a = request.share.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkUpdateShareProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listShares(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listSharesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listShares.createStream(this.innerApiCalls.listShares, request, callSettings);
    }
    /**
    ...
    listSharesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listShares.asyncIterate(this.innerApiCalls['listShares'], request, callSettings);
    }
    /**
...
exports.CloudFilestoreManagerClient = CloudFilestoreManagerClient;
//# sourceMappingURL=cloud_filestore_manager_client.js.map