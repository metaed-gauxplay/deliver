...
class InstancesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        const debugInstanceResponse = protoFilesRoot.lookup('.google.appengine.v1.Instance');
        const debugInstanceMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        this.descriptors.longrunning = {
            ...
            debugInstance: new this._gaxModule.LongrunningDescriptor(this.operationsClient, debugInstanceResponse.decode.bind(debugInstanceResponse), debugInstanceMetadata.decode.bind(debugInstanceMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.appengine.v1.Instances', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.instancesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.appengine.v1.Instances')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.appengine.v1.Instances, this._opts, this._providedCustomServicePath);
    ...
    debugInstance(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDebugInstanceProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
