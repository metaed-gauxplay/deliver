...
class VersionsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createVersionResponse = protoFilesRoot.lookup('.google.appengine.v1.Version');
        const createVersionMetadata = protoFilesRoot.lookup('.google.appengine.v1.CreateVersionMetadataV1');
        const updateVersionResponse = protoFilesRoot.lookup('.google.appengine.v1.Version');
        const updateVersionMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        const deleteVersionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteVersionMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        this.descriptors.longrunning = {
            ...
            updateVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateVersionResponse.decode.bind(updateVersionResponse), updateVersionMetadata.decode.bind(updateVersionMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.appengine.v1.Versions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.versionsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.appengine.v1.Versions')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.appengine.v1.Versions, this._opts, this._providedCustomServicePath);
     ...
     */
    async checkUpdateVersionProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
