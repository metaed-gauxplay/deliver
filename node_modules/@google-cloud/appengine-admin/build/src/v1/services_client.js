...
class ServicesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const updateServiceResponse = protoFilesRoot.lookup('.google.appengine.v1.Service');
        const updateServiceMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        const deleteServiceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteServiceMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.appengine.v1.Services', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.servicesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.appengine.v1.Services')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.appengine.v1.Services, this._opts, this._providedCustomServicePath);
