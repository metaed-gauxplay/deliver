...
exports.AuthorizedDomainsClient = void 0;
 ...
 */
const gapicConfig = require("./authorized_domains_client_config.json");
...
class AuthorizedDomainsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listAuthorizedDomains: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'domains'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.appengine.v1.AuthorizedDomains', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.authorizedDomainsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.appengine.v1.AuthorizedDomains')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.appengine.v1.AuthorizedDomains, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of authorizedDomainsStubMethods) {
            const callPromise = this.authorizedDomainsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listAuthorizedDomains(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    listAuthorizedDomainsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listAuthorizedDomains.createStream(this.innerApiCalls.listAuthorizedDomains, request, callSettings);
    }
    /**
    ...
    listAuthorizedDomainsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listAuthorizedDomains.asyncIterate(this.innerApiCalls['listAuthorizedDomains'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.AuthorizedDomainsClient = AuthorizedDomainsClient;
//# sourceMappingURL=authorized_domains_client.js.map