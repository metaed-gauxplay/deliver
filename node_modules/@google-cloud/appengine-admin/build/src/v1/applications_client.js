 ...
 */
const gapicConfig = require("./applications_client_config.json");
...
class ApplicationsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createApplicationResponse = protoFilesRoot.lookup('.google.appengine.v1.Application');
        const createApplicationMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        const updateApplicationResponse = protoFilesRoot.lookup('.google.appengine.v1.Application');
        const updateApplicationMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        const repairApplicationResponse = protoFilesRoot.lookup('.google.appengine.v1.Application');
        const repairApplicationMetadata = protoFilesRoot.lookup('.google.appengine.v1.OperationMetadataV1');
        this.descriptors.longrunning = {
            createApplication: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createApplicationResponse.decode.bind(createApplicationResponse), createApplicationMetadata.decode.bind(createApplicationMetadata)),
            updateApplication: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateApplicationResponse.decode.bind(updateApplicationResponse), updateApplicationMetadata.decode.bind(updateApplicationMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.appengine.v1.Applications', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.applicationsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.appengine.v1.Applications')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.appengine.v1.Applications, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of applicationsStubMethods) {
            const callPromise = this.applicationsStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    async checkCreateApplicationProgress(name) {
     ...
     */
    async checkUpdateApplicationProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    repairApplication(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkRepairApplicationProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
...
//# sourceMappingURL=applications_client.js.map