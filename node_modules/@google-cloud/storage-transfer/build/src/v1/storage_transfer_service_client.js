...
exports.StorageTransferServiceClient = void 0;
 ...
 */
const gapicConfig = require("./storage_transfer_service_client_config.json");
...
class StorageTransferServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            agentPoolsPathTemplate: new this._gaxModule.PathTemplate('projects/{project_id}/agentPools/{agent_pool_id}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listTransferJobs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'transferJobs'),
            listAgentPools: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'agentPools'),
        };
        ...
        const runTransferJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const runTransferJobMetadata = protoFilesRoot.lookup('.google.storagetransfer.v1.TransferOperation');
        this.descriptors.longrunning = {
            runTransferJob: new this._gaxModule.LongrunningDescriptor(this.operationsClient, runTransferJobResponse.decode.bind(runTransferJobResponse), runTransferJobMetadata.decode.bind(runTransferJobMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.storagetransfer.v1.StorageTransferService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.storageTransferServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.storagetransfer.v1.StorageTransferService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.storagetransfer.v1
                    .StorageTransferService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of storageTransferServiceStubMethods) {
            const callPromise = this.storageTransferServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getGoogleServiceAccount(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createTransferJob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateTransferJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                job_name: (_a = request.jobName) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateTransferJob(request, options, callback);
    }
    getTransferJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    pauseTransferOperation(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    resumeTransferOperation(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteTransferJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createAgentPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateAgentPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'agent_pool.name': (_a = request.agentPool.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateAgentPool(request, options, callback);
    }
    getAgentPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteAgentPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    runTransferJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkRunTransferJobProgress(name) {
    ...
    listTransferJobs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listTransferJobsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listTransferJobs.createStream(this.innerApiCalls.listTransferJobs, request, callSettings);
    }
    /**
    ...
    listTransferJobsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTransferJobs.asyncIterate(this.innerApiCalls['listTransferJobs'], request, callSettings);
    }
    listAgentPools(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listAgentPoolsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listAgentPools.createStream(this.innerApiCalls.listAgentPools, request, callSettings);
    }
    /**
    ...
    listAgentPoolsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listAgentPools.asyncIterate(this.innerApiCalls['listAgentPools'], request, callSettings);
    }
    /**
...
exports.StorageTransferServiceClient = StorageTransferServiceClient;
//# sourceMappingURL=storage_transfer_service_client.js.map