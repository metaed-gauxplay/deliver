 ...
 */
const gapicConfig = require("./policies_client_config.json");
...
class PoliciesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listPolicies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'policies'),
        };
        ...
        const createPolicyResponse = protoFilesRoot.lookup('.google.iam.v2.Policy');
        const createPolicyMetadata = protoFilesRoot.lookup('.google.iam.v2.PolicyOperationMetadata');
        const updatePolicyResponse = protoFilesRoot.lookup('.google.iam.v2.Policy');
        const updatePolicyMetadata = protoFilesRoot.lookup('.google.iam.v2.PolicyOperationMetadata');
        const deletePolicyResponse = protoFilesRoot.lookup('.google.iam.v2.Policy');
        const deletePolicyMetadata = protoFilesRoot.lookup('.google.iam.v2.PolicyOperationMetadata');
        this.descriptors.longrunning = {
            createPolicy: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createPolicyResponse.decode.bind(createPolicyResponse), createPolicyMetadata.decode.bind(createPolicyMetadata)),
            updatePolicy: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updatePolicyResponse.decode.bind(updatePolicyResponse), updatePolicyMetadata.decode.bind(updatePolicyMetadata)),
            deletePolicy: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deletePolicyResponse.decode.bind(deletePolicyResponse), deletePolicyMetadata.decode.bind(deletePolicyMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.iam.v2.Policies', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.policiesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.iam.v2.Policies')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.iam.v2.Policies, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of policiesStubMethods) {
            const callPromise = this.policiesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createPolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreatePolicyProgress(name) {
    ...
    updatePolicy(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'policy.name': (_a = request.policy.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkUpdatePolicyProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deletePolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeletePolicyProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listPolicies(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listPoliciesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listPolicies.createStream(this.innerApiCalls.listPolicies, request, callSettings);
    }
    /**
    ...
    listPoliciesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPolicies.asyncIterate(this.innerApiCalls['listPolicies'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=policies_client.js.map