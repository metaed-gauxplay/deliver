...
exports.OsLoginServiceClient = void 0;
...
class OsLoginServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            posixAccountPathTemplate: new this._gaxModule.PathTemplate('users/{user}/projects/{project}'),
            sshPublicKeyPathTemplate: new this._gaxModule.PathTemplate('users/{user}/sshPublicKeys/{fingerprint}'),
            userPathTemplate: new this._gaxModule.PathTemplate('users/{user}'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.oslogin.v1beta.OsLoginService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.osLoginServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.oslogin.v1beta.OsLoginService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.oslogin.v1beta.OsLoginService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of osLoginServiceStubMethods) {
            const callPromise = this.osLoginServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createSshPublicKey(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    deletePosixAccount(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteSshPublicKey(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getLoginProfile(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getSshPublicKey(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    importSshPublicKey(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateSshPublicKey(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    signSshPublicKey(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
...
exports.OsLoginServiceClient = OsLoginServiceClient;
//# sourceMappingURL=os_login_service_client.js.map